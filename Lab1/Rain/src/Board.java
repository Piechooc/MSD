		...
		for (x = 0; x < points.length; ++x) {
			for (y = 0; y < points[x].length; ++y) {
				if (points[x][y].getState() != 0) {
					...
					case 1:
						g.setColor(new Color(0x510000FF, true));
						break;
					case 2:
						g.setColor(new Color(0x6B0000FF, true));
						break;
					case 3:
						g.setColor(new Color(0x830000FF, true));
						break;						
					case 4:
						g.setColor(new Color(0xAE0000FF, true));
						break;						
					case 5:
						g.setColor(new Color(0xDF0000FF, true));
						break;						
					case 6:
